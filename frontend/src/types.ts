...
export type ScanResult = { disposition:'added'|'confirmation'|'suggestions'|'queued'; confidence:number; inventory:Inventory|null; candidates:Candidate[]; review_id:string|null; message:string; processing_ms:number }
