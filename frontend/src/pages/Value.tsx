...
function timeline(points:Point[],range:Window,end:number){
  ...
  return {start,result,ticks:Array.from({length:Math.floor((end-start)/interval)+1},(_,index)=>start+index*interval)}
}
