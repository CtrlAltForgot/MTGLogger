...
import { Inventory2, Style } from '@mui/icons-material'
import {
  Alert, Box, Button, Dialog, DialogActions, DialogContent, DialogTitle,
  MenuItem, Stack, TextField, ToggleButton, ToggleButtonGroup,
  Typography,
} from '@mui/material'
import { request } from '../api'
import type { Candidate, Inventory } from '../types'
...
export default function ManualAddDialog({open,onClose,onAdded}:{open:boolean;onClose:()=>void;onAdded:(item?:Inventory)=>void}){
  const [kind,setKind]=useState<Kind>('card'),[selected,setSelected]=useState<Candidate|null>(null)
  ...
  const close=()=>{if(!busy){onClose();setSelected(null);setError(undefined)}}
